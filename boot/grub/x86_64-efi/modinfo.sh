...
grub_target_cc_version='x86_64-pc-linux-gnu-gcc (Gentoo 9.3.0 p2) 9.3.0'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=X86_64_EFI -m64 -nostdinc -isystem /usr/lib/gcc/x86_64-pc-linux-gnu/9.3.0/include -I$(top_srcdir)/include -I$(top_builddir)/include'
